...
{
    private List<GameObject> airborneObservationPaths = new List<GameObject>();
    private List<GameObject> airborneEscapePaths = new List<GameObject>();
    private List<GameObject> terrestrialObservationPaths = new List<GameObject>();
    private List<GameObject> terrestrialEscapePaths = new List<GameObject>();
