...
//public class MovingTarget : MonoBehaviour, IArrowTarget
//{
//    // Enum for choosing which element is required to damage this target
//    public enum RequiredElementChoice
//    {
//        Any,        // Any element works
//        Fire,
//        Electric,
//        Sticky,
//        Stasis,
...
//    // Stores the currently active element type for future gameplay logic (like arrow hit checking)
//    public ElementTypeOB7 CurrentElementType { get; private set; } = ElementTypeOB7.Normal;
...
//    [Header("Target Settings")]
//    [Tooltip("How much health this target has. 1 = one hit kill.")]
//    [SerializeField]
//    private float health = 1f;
...
//    [Tooltip("Which element is required to damage this target. Pick 'Any' to allow all elements.")]
//    [SerializeField]
//    private RequiredElementChoice requiredElement = RequiredElementChoice.Any;
...
//    {
//        // If not managed by SandboxResetManager, just default to Normal. 
//        // SandboxResetManager will call SetRoundDifficulty directly to progress it!
//    }

//    private void Update()
//    {
//        // Only run shifting logic if enabled, not stopped, and past round 0
//        if (shiftsElementsMidGame && !stopped && CurrentElementType != ElementTypeOB7.Normal)
//        {
//            shiftTimer += Time.deltaTime;
//            if (shiftTimer >= shiftInterval)
...
//    /// <summary>
//    /// Called by SandboxResetManager to slowly increase difficulty round by round.
//    /// </summary>
//    public void SetRoundDifficulty(int round)
//    {
//        currentMaxDifficulty = round;
...
//        if (round == 0)
//        {
//            // First round: keep it completely normal
//            CurrentElementType = ElementTypeOB7.Normal;
//            if (targetRenderer != null && originalMaterial != null)
//            {
//                targetRenderer.material = originalMaterial;
...
//        else
//        {
//            // Higher rounds: slowly introduce more elements!
//            SetRandomElement();
//        }
//    }

//    /// <summary>
//    /// Randomly selects an element based on the current difficulty progression.
//    /// </summary>
//    public void SetRandomElement()
//    {
//        if (availableElements == null || availableElements.Length == 0)
...
//        // The maximum element index we can pick depends on the round!
//        // Round 1 unlocks index 0. Round 2 unlocks index 1, etc.
//        int maxAllowedIndex = Mathf.Min(currentMaxDifficulty, availableElements.Length);
//        int randomIndex = Random.Range(0, maxAllowedIndex);
...
//        // Handle high-speed crash damage (e.g., from Rope Arrow violent pull)
//        if (!stopped && rb != null && !rb.isKinematic)
//        {
//            float crashSpeed = collision.relativeVelocity.magnitude;
//            float fatalCrashThreshold = 4f;
...
//    // This function handles damage to enemies from arrows.
//    public void OnArrowHit(float damage, Vector3 impactPoint, ElementTypeOB7 elementType)
//    {
//        Debug.Log($"<color=cyan>[MovingTarget] '{gameObject.name}' received OnArrowHit with Damage: {damage}, Element: {elementType}.</color>");

//        // If it's a 0-damage hit (like from a Rope Arrow), intercept it and notify the rope system!
//        if (damage <= 0f && elementType == ElementTypeOB7.Normal)
//        {
//            Debug.Log($"<color=cyan>[MovingTarget] 0-damage hit detected! Registering rope arrow.</color>");
//            if (RopeArrowManagerObi7.Instance != null)
...
//        // Check if this target requires a specific element
//        // If requiredElement is Any, allow all elements
//        if (requiredElement != RequiredElementChoice.Any)
//        {
//            // Convert RequiredElementChoice to ElementTypeOB7
//            ElementTypeOB7 requiredOB7 = ElementTypeOB7.Normal;
//            switch (requiredElement)
//            {
//                case RequiredElementChoice.Fire: requiredOB7 = ElementTypeOB7.Fire; break;
//                case RequiredElementChoice.Electric: requiredOB7 = ElementTypeOB7.Electric; break;
//                case RequiredElementChoice.Sticky: requiredOB7 = ElementTypeOB7.Sticky; break;
//                case RequiredElementChoice.Stasis: requiredOB7 = ElementTypeOB7.Stasis; break;
//                case RequiredElementChoice.Ice: requiredOB7 = ElementTypeOB7.Ice; break;
//            }

//            if (elementType != requiredOB7)
//            {
//                Debug.Log($"<color=orange>[MovingTarget] Target requires {requiredElement} arrow, but got {elementType}. No damage taken.</color>");
//                return;
//            }
//        }

//        // Take damage from the arrow
//        TakeDamage(damage, impactPoint);
//    }
